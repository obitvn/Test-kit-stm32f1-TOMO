...
uint8_t left=0, right=0, up=0, down=0, ok=0;
...
int main(void)
{
  ...
  while (1)
  {
		if(left==1)
			{
				LCD_Gotoxy(0,1);
	      LCD_Puts("Ban da bam LEFT");
				left=0;
			}
		if(right==1)
			{
				LCD_Gotoxy(0,1);
	      LCD_Puts("Ban da bam RIGHT"); 
				right=0;
			}
		if(up==1)
			{
				LCD_Gotoxy(0,1);
	      LCD_Puts("Ban da bam UP    ");
				up=0;
			}
		if(down==1)
			{
				LCD_Gotoxy(0,1);
	      LCD_Puts("Ban da bam DOWN  ");
				down=0;
			}
		if(ok==1)
			{
				LCD_Gotoxy(0,1);
	      LCD_Puts("Ban da bam OK     ");
				ok=0;
			}
